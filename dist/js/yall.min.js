  ...
  return function(e) {
    var n = (e = e || {}).lazyClass || "lazy",
      ...
      f = function(n) {
        var o,
          i = n.parentNode;
        "PICTURE" == i.nodeName && (o = i),
          "VIDEO" == n.nodeName && (o = n),
          g(l("source", o), b),
          b(n),
          n.autoplay && n.load();
        var r = n.classList;
        r.contains(t) &&
          (r.remove(t), r.add(e.lazyBackgroundLoaded || "lazy-bg-loaded"));
      },
      v = function(e) {
        for (var n in r)
      ...
      g = function(e, n) {
        for (var t in e) n instanceof a[u] ? n.observe(e[t]) : n(e[t]);
      },
      m = function(e) {
    ...
    if (/baidu|(?:google|bing|yandex|duckduck)bot/i.test(navigator.userAgent))
      ...
      g(h, v),
        g(h, p),
        i &&
          g(l(e.observeRootSelector || "body"), function(n) {
