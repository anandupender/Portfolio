...
nav.innerHTML += `
  ...
  <nav class="navigation">
    ...
    <li>
      ...
      <li><a href="mailto:anand.upender@gmail.com" class="menu-buttons" id="instagram" title="instagram">
      <svg width="28" height="22" viewBox="0 0 33 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-top:3px">
